...
if dry_run == "true":
    ...
    recommended_next_skill = "migration-openrewrite" if exit_code_int == 0 else "migration-openrewrite"
elif exit_code_int != 0:
    status = "rewrite_failed"
    recommended_next_skill = "migration-openrewrite"
elif validation_status == "failed":
    status = "rewrite_applied_validation_failed"
    recommended_next_skill = "migration-last-mile-fixer"
else:
...
payload = {
    ...
    "recommended_path": "last-mile" if recommended_next_skill == "migration-last-mile-fixer" else "openrewrite",
