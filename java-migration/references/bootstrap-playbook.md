...
2. Run `scripts/bootstrap/migration-kit.sh start <repo-root>` when the migration output is missing.
...
- Keep the persisted state resumable without prior chat context.
